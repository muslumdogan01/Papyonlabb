...
const HeroBg = () => {
  return (
    <div className="relative w-full h-full ">
      <div
        className="absolute top-0 h-full w-full bg-cover bg-center inset-0 bg-[#151518]"
        style={{
          backgroundImage: "linear-gradient(to bottom, transparent, #151518), url('/hero.png')",
      ...
      >
        ...
        <div className="  text-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-0 px-4 flex flex-col items-center w-full">
          <div className="space-x-1 justify-center items-center text-[20px] leading-[28px] font-normal text-white font-geist md:flex hidden relative">
            <span> Our</span>
            <span>
              <Image src="/icons/hero1.svg" alt="Icon" width={24} height={24}/>
            </span>
            <span>mobile new world. We do fun things in this</span>
            <span>
              <Image src="/icons/world.svg" alt="Icon" width={24} height={24} />
            </span>
            <span>world</span>
          </div>
